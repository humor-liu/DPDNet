...
parser.add_argument('--datapath', default="/media/lan/581B65F3EBFAC14D/liu/Datasets/SceneFlow/", help='data path')
...
parser.add_argument('--save_freq', type=int, default=5, help='the frequency of saving checkpoint')
